...
namespace Info
  ...
  def source_file : String := "/Users/ecivini/Projects/CompCert-3.17/test/lean/demo.c"
...
def _dist2 : Ident := identOfString "dist2"
...
def _sum_to : Ident := identOfString "sum_to"
...
def f_sum_to : Function := {
  fn_return := tint,
  fn_callconv := cc_default,
  fn_params := [(_n, tint)],
  fn_vars := [],
  fn_temps := [(_i, tint), (_s, tint)],
  fn_body :=
(Stmt.Ssequence
  (Stmt.Sset _s (Expr.Econst_int (Integers.Int.repr 0) tint))
  (Stmt.Ssequence
    (Stmt.Ssequence
      (Stmt.Sset _i (Expr.Econst_int (Integers.Int.repr 0) tint))
      (Stmt.Sloop
        (Stmt.Ssequence
          (Stmt.Sifthenelse (Expr.Ebinop Binop.Olt (Expr.Etempvar _i tint)
                              (Expr.Etempvar _n tint) tint)
            Stmt.Sskip
            Stmt.Sbreak)
          (Stmt.Sset _s
            (Expr.Ebinop Binop.Oadd (Expr.Etempvar _s tint)
              (Expr.Etempvar _i tint) tint)))
        (Stmt.Sset _i
          (Expr.Ebinop Binop.Oadd (Expr.Etempvar _i tint)
            (Expr.Econst_int (Integers.Int.repr 1) tint) tint))))
    (Stmt.Sreturn (some (Expr.Etempvar _s tint)))))
}

def f_dist2 : Function := {
  fn_return := tint,
  fn_callconv := cc_default,
  fn_params := [(_p, (tptr (Ty.Tstruct _point noattr)))],
  fn_vars := [],
  fn_temps := [(_t'4, tint), (_t'3, tint), (_t'2, tint), (_t'1, tint)],
  fn_body :=
(Stmt.Ssequence
  (Stmt.Sset _t'1
    (Expr.Efield
      (Expr.Ederef (Expr.Etempvar _p (tptr (Ty.Tstruct _point noattr)))
        (Ty.Tstruct _point noattr)) _x tint))
  (Stmt.Ssequence
    (Stmt.Sset _t'2
      (Expr.Efield
        (Expr.Ederef (Expr.Etempvar _p (tptr (Ty.Tstruct _point noattr)))
    ...
    (Stmt.Ssequence
      (Stmt.Sset _t'3
        (Expr.Efield
          (Expr.Ederef (Expr.Etempvar _p (tptr (Ty.Tstruct _point noattr)))
            (Ty.Tstruct _point noattr)) _y tint))
      (Stmt.Ssequence
        (Stmt.Sset _t'4
          (Expr.Efield
            (Expr.Ederef (Expr.Etempvar _p (tptr (Ty.Tstruct _point noattr)))
        ...
        (Stmt.Sreturn (some (Expr.Ebinop Binop.Oadd
                              (Expr.Ebinop Binop.Omul
                                ...
                                (Expr.Etempvar _t'2 tint) tint)
                              (Expr.Ebinop Binop.Omul
                                (Expr.Etempvar _t'3 tint)
                                (Expr.Etempvar _t'4 tint) tint) tint)))))))
}
...
def f_main : Function := {
  ...
  fn_params := [],
  fn_vars := [],
  fn_temps := [(_t'1, tint), (_t'2, tint)],
  fn_body :=
(Stmt.Ssequence
  (Stmt.Ssequence
    (Stmt.Ssequence
      (Stmt.Sset _t'2 (Expr.Evar _g tint))
      (Stmt.Scall (some _t'1)
        (Expr.Evar _sum_to (Ty.Tfunction [tint] tint cc_default))
...
[(CompositeDef.Composite _point SU.Struct
   [(Member.Member_plain _x tint), (Member.Member_plain _y tint)]
   noattr)]
...
[(___compcert_va_int32,
 ...
 (___builtin_debug,
   GlobDef.Gfun (FunDef.External (ExtFun.EF_external "__builtin_debug"
     ...
     [tint] tvoid
     { cc_vararg := (some 1), cc_unproto := false, cc_structret := false })),
 (_g, GlobDef.Gvar v_g), (_sum_to, GlobDef.Gfun (FunDef.Internal f_sum_to)),
 (_dist2, GlobDef.Gfun (FunDef.Internal f_dist2)),
 (_main, GlobDef.Gfun (FunDef.Internal f_main))]

def public_idents : List Ident :=
[_main, _dist2, _sum_to, _g, ___builtin_debug, ___builtin_fmin,
 ___builtin_fmax, ___builtin_fnmsub, ___builtin_fnmadd, ___builtin_fmsub,
 ___builtin_fmadd, ___builtin_clsll, ___builtin_clsl, ___builtin_cls,
 ___builtin_expect, ___builtin_unreachable, ___builtin_va_end,
 ___builtin_va_copy, ___builtin_va_arg, ___builtin_va_start,
 ___builtin_membar, ___builtin_annot_intval, ___builtin_annot,
 ___builtin_sel, ___builtin_memcpy_aligned, ___builtin_sqrt,
 ___builtin_fsqrt, ___builtin_fabsf, ___builtin_fabs, ___builtin_ctzll,
 ___builtin_ctzl, ___builtin_ctz, ___builtin_clzll, ___builtin_clzl,
 ___builtin_clz, ___builtin_bswap16, ___builtin_bswap32, ___builtin_bswap,
