...
Module Info.
  ...
  Definition source_file := "test/lean/demo.c".
...
Definition _sum_to : ident := $"sum_to".
...
Definition f_dist2 := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_p, (tptr (Tstruct _point noattr))) :: nil);
  fn_vars := nil;
...
(Ssequence
  (Sset _t'1
    (Efield
      (Ederef (Etempvar _p (tptr (Tstruct _point noattr)))
    ...
    (Ssequence
      ...
      (Ssequence
        ...
        (Sreturn (Some (Ebinop Oadd
                         ...
                         (Ebinop Omul (Etempvar _t'3 tint)
                           (Etempvar _t'4 tint) tint) tint)))))))
|}.
...
(Ssequence
  (Ssequence
    (Ssequence
      ...
      (Scall (Some _t'1)
        (Evar _sum_to (Tfunction (tint :: nil) tint cc_default))
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     (tint :: nil) tvoid
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_g, Gvar v_g) :: (_sum_to, Gfun(Internal f_sum_to)) ::
 (_dist2, Gfun(Internal f_dist2)) :: (_main, Gfun(Internal f_main)) :: nil).
