...
namespace Info
  ...
  def source_file : String := "zutil.c"
...
def _calloc : Ident := identOfString "calloc"
def _err : Ident := identOfString "err"
def _flags : Ident := identOfString "flags"
def _free : Ident := identOfString "free"
def _items : Ident := identOfString "items"
def _main : Ident := identOfString "main"
def _malloc : Ident := identOfString "malloc"
def _opaque : Ident := identOfString "opaque"
def _ptr : Ident := identOfString "ptr"
def _size : Ident := identOfString "size"
def _zError : Ident := identOfString "zError"
def _z_errmsg : Ident := identOfString "z_errmsg"
def _zcalloc : Ident := identOfString "zcalloc"
def _zcfree : Ident := identOfString "zcfree"
def _zlibCompileFlags : Ident := identOfString "zlibCompileFlags"
def _zlibVersion : Ident := identOfString "zlibVersion"
...
def v___stringlit_5 : GlobVar Ty := {
  ...
  gvar_init := [(InitData.Init_int8 (Integers.Int.repr 100)),
...
def v___stringlit_8 : GlobVar Ty := {
  gvar_info := (tarray tschar 11),
  gvar_init := [(InitData.Init_int8 (Integers.Int.repr 115)),
                (InitData.Init_int8 (Integers.Int.repr 116)),
                (InitData.Init_int8 (Integers.Int.repr 114)),
                (InitData.Init_int8 (Integers.Int.repr 101)),
                (InitData.Init_int8 (Integers.Int.repr 97)),
...
def v___stringlit_9 : GlobVar Ty := {
  ...
  gvar_init := [(InitData.Init_int8 (Integers.Int.repr 110)),
                (InitData.Init_int8 (Integers.Int.repr 101)),
                (InitData.Init_int8 (Integers.Int.repr 101)),
                (InitData.Init_int8 (Integers.Int.repr 100)),
                (InitData.Init_int8 (Integers.Int.repr 32)),
...
def v___stringlit_3 : GlobVar Ty := {
  ...
  gvar_init := [(InitData.Init_int8 (Integers.Int.repr 98)),
                (InitData.Init_int8 (Integers.Int.repr 117)),
...
def v___stringlit_7 : GlobVar Ty := {
  gvar_info := (tarray tschar 11),
  gvar_init := [(InitData.Init_int8 (Integers.Int.repr 102)),
                (InitData.Init_int8 (Integers.Int.repr 105)),
                (InitData.Init_int8 (Integers.Int.repr 108)),
                (InitData.Init_int8 (Integers.Int.repr 101)),
                (InitData.Init_int8 (Integers.Int.repr 32)),
...
def v_z_errmsg : GlobVar Ty := {
  gvar_info := (tarray (tptr tschar) 10),
  gvar_init := [(InitData.Init_addrof ___stringlit_9 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_8 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_1 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_7 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_6 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_5 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_4 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_3 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_2 (Integers.Ptrofs.repr 0)),
                (InitData.Init_addrof ___stringlit_1 (Integers.Ptrofs.repr 0))],
  gvar_readonly := true,
  gvar_volatile := false
}

def f_zlibVersion : Function := {
  ...
  fn_temps := [],
  fn_body :=
(Stmt.Sreturn (some (Expr.Evar ___stringlit_10 (tarray tschar 6))))
}

def f_zlibCompileFlags : Function := {
  fn_return := tulong,
  fn_callconv := cc_default,
  fn_params := [],
  fn_vars := [],
  fn_temps := [(_flags, tulong)],
  fn_body :=
(Stmt.Ssequence
  (Stmt.Sset _flags
    (Expr.Ecast (Expr.Econst_int (Integers.Int.repr 0) tint) tulong))
  (Stmt.Ssequence
    (Stmt.Sswitch (Expr.Ecast (Expr.Esizeof tuint tulong) tint)
      (LStmts.LScons (some 2)
        Stmt.Sbreak
        (LStmts.LScons (some 4)
          (Stmt.Ssequence
            (Stmt.Sset _flags
              (Expr.Ebinop Binop.Oadd (Expr.Etempvar _flags tulong)
                (Expr.Econst_int (Integers.Int.repr 1) tint) tulong))
            Stmt.Sbreak)
          (LStmts.LScons (some 8)
            (Stmt.Ssequence
              (Stmt.Sset _flags
                (Expr.Ebinop Binop.Oadd (Expr.Etempvar _flags tulong)
                  (Expr.Econst_int (Integers.Int.repr 2) tint) tulong))
              Stmt.Sbreak)
            (LStmts.LScons none
              (Stmt.Sset _flags
                (Expr.Ebinop Binop.Oadd (Expr.Etempvar _flags tulong)
              ...
              LStmts.LSnil)))))
    (Stmt.Ssequence
      (Stmt.Sswitch (Expr.Ecast (Expr.Esizeof tulong tulong) tint)
        (LStmts.LScons (some 2)
          Stmt.Sbreak
          (LStmts.LScons (some 4)
            (Stmt.Ssequence
            ...
            (LStmts.LScons (some 8)
              ...
              (LStmts.LScons none
                ...
                LStmts.LSnil)))))
      (Stmt.Ssequence
        (Stmt.Sswitch (Expr.Ecast (Expr.Esizeof (tptr tvoid) tulong) tint)
          (LStmts.LScons (some 2)
            Stmt.Sbreak
            (LStmts.LScons (some 4)
              (Stmt.Ssequence
              ...
              (LStmts.LScons (some 8)
                ...
                (LStmts.LScons none
                  ...
                  LStmts.LSnil)))))
        (Stmt.Ssequence
          (Stmt.Sswitch (Expr.Ecast (Expr.Esizeof tlong tulong) tint)
            (LStmts.LScons (some 2)
              Stmt.Sbreak
              (LStmts.LScons (some 4)
                (Stmt.Ssequence
                  (Stmt.Sset _flags
                    (Expr.Ebinop Binop.Oadd (Expr.Etempvar _flags tulong)
                      (Expr.Ebinop Binop.Oshl
                        (Expr.Econst_int (Integers.Int.repr 1) tint)
                        (Expr.Econst_int (Integers.Int.repr 6) tint) tint)
                      tulong))
                  Stmt.Sbreak)
                (LStmts.LScons (some 8)
                  (Stmt.Ssequence
                  ...
                  (LStmts.LScons none
                    (Stmt.Sset _flags
                      (Expr.Ebinop Binop.Oadd (Expr.Etempvar _flags tulong)
                        ...
                        tulong))
                    LStmts.LSnil)))))
          (Stmt.Sreturn (some (Expr.Etempvar _flags tulong))))))))
}

def f_zError : Function := {
  fn_return := (tptr tschar),
  fn_callconv := cc_default,
  fn_params := [(_err, tint)],
  fn_vars := [],
  fn_temps := [(_t'2, tint), (_t'1, tint), (_t'3, (tptr tschar))],
  fn_body :=
(Stmt.Ssequence
  (Stmt.Ssequence
    (Stmt.Sifthenelse (Expr.Ebinop Binop.Olt (Expr.Etempvar _err tint)
      ...
      (Stmt.Sset _t'1
        (Expr.Ecast
          (Expr.Ebinop Binop.Ogt (Expr.Etempvar _err tint)
            (Expr.Econst_int (Integers.Int.repr 2) tint) tint) tbool)))
    (Stmt.Sifthenelse (Expr.Etempvar _t'1 tint)
      (Stmt.Sset _t'2
        (Expr.Ecast (Expr.Econst_int (Integers.Int.repr 9) tint) tint))
      (Stmt.Sset _t'2
        (Expr.Ecast
          (Expr.Ebinop Binop.Osub
            (Expr.Econst_int (Integers.Int.repr 2) tint)
            (Expr.Etempvar _err tint) tint) tint))))
  (Stmt.Ssequence
    (Stmt.Sset _t'3
      (Expr.Ederef
        (Expr.Ebinop Binop.Oadd
          (Expr.Evar _z_errmsg (tarray (tptr tschar) 10))
          (Expr.Etempvar _t'2 tint) (tptr (tptr tschar))) (tptr tschar)))
    (Stmt.Sreturn (some (Expr.Etempvar _t'3 (tptr tschar))))))
}

def f_zcalloc : Function := {
  fn_return := (tptr tvoid),
  fn_callconv := cc_default,
  fn_params := [(_opaque, (tptr tvoid)), (_items, tuint), (_size, tuint)],
  fn_vars := [],
  fn_temps := [(_t'3, (tptr tvoid)), (_t'2, (tptr tvoid)),
               (_t'1, (tptr tvoid))],
  fn_body :=
(Stmt.Ssequence
  (Stmt.Sifthenelse (Expr.Ebinop Binop.Ogt (Expr.Esizeof tuint tulong)
                      (Expr.Econst_int (Integers.Int.repr 2) tint) tint)
    (Stmt.Ssequence
      (Stmt.Scall (some _t'2)
        (Expr.Evar _malloc (Ty.Tfunction [tulong] (tptr tvoid) cc_default))
        [(Expr.Ebinop Binop.Omul (Expr.Etempvar _items tuint)
           (Expr.Etempvar _size tuint) tuint)])
      (Stmt.Sset _t'1
        (Expr.Ecast
          (Expr.Ecast (Expr.Etempvar _t'2 (tptr tvoid)) (tptr tvoid))
          (tptr tvoid))))
    (Stmt.Ssequence
      (Stmt.Scall (some _t'3)
        (Expr.Evar _calloc (Ty.Tfunction [tulong, tulong] (tptr tvoid)
                             cc_default))
        [(Expr.Etempvar _items tuint), (Expr.Etempvar _size tuint)])
      (Stmt.Sset _t'1
        (Expr.Ecast
          (Expr.Ecast (Expr.Etempvar _t'3 (tptr tvoid)) (tptr tvoid))
          (tptr tvoid)))))
  (Stmt.Sreturn (some (Expr.Etempvar _t'1 (tptr tvoid)))))
}

def f_zcfree : Function := {
  fn_return := tvoid,
  fn_callconv := cc_default,
  fn_params := [(_opaque, (tptr tvoid)), (_ptr, (tptr tvoid))],
  fn_vars := [],
  fn_temps := [],
  fn_body :=
(Stmt.Scall none
  (Expr.Evar _free (Ty.Tfunction [(tptr tvoid)] tvoid cc_default))
  [(Expr.Etempvar _ptr (tptr tvoid))])
}
...
[(___compcert_va_int32,
 ...
 (___builtin_debug,
   GlobDef.Gfun (FunDef.External (ExtFun.EF_external "__builtin_debug"
     ...
     { cc_vararg := (some 1), cc_unproto := false, cc_structret := false })),
 (_malloc,
   GlobDef.Gfun (FunDef.External ExtFun.EF_malloc [tulong] (tptr tvoid)
     cc_default)),
 (_calloc,
   GlobDef.Gfun (FunDef.External (ExtFun.EF_external "calloc"
                                   (mksignature [XType.Xlong, XType.Xlong]
                                     XType.Xptr cc_default)) [tulong, tulong]
     (tptr tvoid) cc_default)),
 (_free,
   GlobDef.Gfun (FunDef.External ExtFun.EF_free [(tptr tvoid)] tvoid
     cc_default)), (_z_errmsg, GlobDef.Gvar v_z_errmsg),
 (_zlibVersion, GlobDef.Gfun (FunDef.Internal f_zlibVersion)),
 (_zlibCompileFlags, GlobDef.Gfun (FunDef.Internal f_zlibCompileFlags)),
 (_zError, GlobDef.Gfun (FunDef.Internal f_zError)),
 (_zcalloc, GlobDef.Gfun (FunDef.Internal f_zcalloc)),
 (_zcfree, GlobDef.Gfun (FunDef.Internal f_zcfree))]

def public_idents : List Ident :=
[_zcfree, _zcalloc, _zError, _zlibCompileFlags, _zlibVersion, _z_errmsg,
 _free, _calloc, _malloc, ___builtin_debug, ___builtin_fmin, ___builtin_fmax,
