...
namespace Info
  ...
  def source_file : String := "uncompr.c"
...
def _uncompress : Ident := identOfString "uncompress"
def _uncompress2 : Ident := identOfString "uncompress2"
def _uncompress2_z : Ident := identOfString "uncompress2_z"
def _uncompress_z : Ident := identOfString "uncompress_z"
...
def f_uncompress2_z : Function := {
  fn_return := tint,
  fn_callconv := cc_default,
  fn_params := [(_dest, (tptr tuchar)), (_destLen, (tptr tulong)),
                (_source, (tptr tuchar)), (_sourceLen, (tptr tulong))],
  fn_vars := [(_stream, (Ty.Tstruct _z_stream_s noattr))],
  fn_temps := [(_err, tint), (_max, tuint), (_len, tulong), (_left, tulong),
               (_t'10, tint), (_t'9, tint), (_t'8, tint), (_t'7, tuint),
               (_t'6, tuint), (_t'5, tint), (_t'4, tint), (_t'3, tint),
               (_t'2, tint), (_t'1, tint), (_t'20, tulong), (_t'19, tulong),
               (_t'18, tuint), (_t'17, tuint), (_t'16, tuint),
               (_t'15, tuint), (_t'14, tuint), (_t'13, tuint),
               (_t'12, tulong), (_t'11, tulong)],
  fn_body :=
(Stmt.Ssequence
  (Stmt.Sset _max
    (Expr.Ecast
      ...
      (Stmt.Ssequence
        (Stmt.Ssequence
          (Stmt.Sifthenelse (Expr.Ebinop Binop.Oeq
                              (Expr.Etempvar _sourceLen (tptr tulong))
                              (Expr.Ecast
            ...
            (Stmt.Ssequence
              (Stmt.Sset _t'20
                (Expr.Ederef (Expr.Etempvar _sourceLen (tptr tulong)) tulong))
              (Stmt.Sifthenelse (Expr.Ebinop Binop.Ogt
                ...
                (Stmt.Ssequence
                  ...
                  (Stmt.Sset _t'1
                    (Expr.Ecast (Expr.Etempvar _t'1 tint) tbool)))
                (Stmt.Sset _t'1
        ...
        (Stmt.Ssequence
          (Stmt.Ssequence
            (Stmt.Sifthenelse (Expr.Ebinop Binop.Oeq
              ...
              (Stmt.Sset _t'4
                (Expr.Ecast
                  (Expr.Ebinop Binop.Oeq (Expr.Etempvar _dest (tptr tuchar))
                    (Expr.Ecast (Expr.Econst_int (Integers.Int.repr 0) tint)
                      (tptr tvoid)) tint) tbool))
              (Stmt.Sset _t'4 (Expr.Econst_int (Integers.Int.repr 0) tint)))
                ...
                (Expr.Ecast
                  (Expr.Eaddrof
                    (Expr.Efield
                      ...
                      _reserved tulong) (tptr tulong)) (tptr tuchar)))
              Stmt.Sskip))
          (Stmt.Ssequence
            (Stmt.Sassign
              (Expr.Efield
                (Expr.Evar _stream (Ty.Tstruct _z_stream_s noattr)) _next_in
                (tptr tuchar))
                    ...
                    (Stmt.Ssequence
                      (Stmt.Ssequence
                        (Stmt.Scall (some _t'5)
                          (Expr.Evar _inflateInit_ (Ty.Tfunction
                          ...
                          [(Expr.Eaddrof
                           ...
                           (Expr.Ecast
                             ...
                             tint)])
                        (Stmt.Sset _err (Expr.Etempvar _t'5 tint)))
                      (Stmt.Ssequence
                                  ...
                                  (Stmt.Ssequence
                                    ...
                                    (Stmt.Ssequence
                                      (Stmt.Scall (some _t'8)
                                        (Expr.Evar _inflate (Ty.Tfunction
                                                              [(tptr (Ty.Tstruct _z_stream_s noattr)),
                                                               tint] tint
                                                              cc_default))
                                        [(Expr.Eaddrof
                                ...
                                (Stmt.Ssequence
                                  ...
                                  (Stmt.Sset _len
                                    (Expr.Ebinop Binop.Oadd
                                      (Expr.Etempvar _len tulong)
                                      (Expr.Etempvar _t'14 tuint) tulong)))
                                (Stmt.Ssequence
                                  (Stmt.Ssequence
                                    (Stmt.Sset _t'13
                                      (Expr.Efield
                                    ...
                                    (Stmt.Sset _left
                                      (Expr.Ebinop Binop.Oadd
                                        (Expr.Etempvar _left tulong)
                                        (Expr.Etempvar _t'13 tuint) tulong)))
                                  (Stmt.Ssequence
                                    (Stmt.Ssequence
                                      (Stmt.Sset _t'12
                                        (Expr.Ederef
                                      ...
                                      (Stmt.Sassign
                                        ...
                                        (Expr.Ebinop Binop.Osub
                                          ...
                                          (Expr.Etempvar _len tulong) tulong)))
                                    (Stmt.Ssequence
                                      (Stmt.Ssequence
                                        (Stmt.Sset _t'11
                                          (Expr.Ederef
                                      ...
                                      (Stmt.Ssequence
                                        (Stmt.Scall none
                                          (Expr.Evar _inflateEnd (Ty.Tfunction
                                                                   [(tptr (Ty.Tstruct _z_stream_s noattr))]
                                                                   tint
                                                                   cc_default))
                                          [(Expr.Eaddrof
...
def f_uncompress2 : Function := {
  fn_return := tint,
  fn_callconv := cc_default,
  fn_params := [(_dest, (tptr tuchar)), (_destLen, (tptr tulong)),
                (_source, (tptr tuchar)), (_sourceLen, (tptr tulong))],
  fn_vars := [(_got, tulong), (_used, tulong)],
  fn_temps := [(_ret, tint), (_t'1, tint), (_t'5, tulong), (_t'4, tulong),
...
(Stmt.Ssequence
  (Stmt.Ssequence
    (Stmt.Sset _t'5
      (Expr.Ederef (Expr.Etempvar _destLen (tptr tulong)) tulong))
    (Stmt.Sassign (Expr.Evar _got tulong) (Expr.Etempvar _t'5 tulong)))
  (Stmt.Ssequence
    (Stmt.Ssequence
      (Stmt.Sset _t'4
        (Expr.Ederef (Expr.Etempvar _sourceLen (tptr tulong)) tulong))
      (Stmt.Sassign (Expr.Evar _used tulong) (Expr.Etempvar _t'4 tulong)))
    (Stmt.Ssequence
      (Stmt.Ssequence
        (Stmt.Scall (some _t'1)
          (Expr.Evar _uncompress2_z (Ty.Tfunction
                                      [(tptr tuchar), (tptr tulong),
                                       (tptr tuchar), (tptr tulong)] tint
                                      cc_default))
          [(Expr.Etempvar _dest (tptr tuchar)),
           (Expr.Eaddrof (Expr.Evar _got tulong) (tptr tulong)),
           (Expr.Etempvar _source (tptr tuchar)),
           (Expr.Eaddrof (Expr.Evar _used tulong) (tptr tulong))])
        (Stmt.Sset _ret (Expr.Etempvar _t'1 tint)))
      (Stmt.Ssequence
        (Stmt.Ssequence
          (Stmt.Sset _t'3 (Expr.Evar _used tulong))
          (Stmt.Sassign
            (Expr.Ederef (Expr.Etempvar _sourceLen (tptr tulong)) tulong)
            (Expr.Ecast (Expr.Etempvar _t'3 tulong) tulong)))
        (Stmt.Ssequence
          (Stmt.Ssequence
...
def f_uncompress_z : Function := {
  fn_return := tint,
  fn_callconv := cc_default,
  fn_params := [(_dest, (tptr tuchar)), (_destLen, (tptr tulong)),
                (_source, (tptr tuchar)), (_sourceLen, tulong)],
  fn_vars := [(_used, tulong)],
  fn_temps := [(_t'1, tint)],
  fn_body :=
(Stmt.Ssequence
  (Stmt.Sassign (Expr.Evar _used tulong) (Expr.Etempvar _sourceLen tulong))
  (Stmt.Ssequence
    (Stmt.Scall (some _t'1)
      (Expr.Evar _uncompress2_z (Ty.Tfunction
                                  [(tptr tuchar), (tptr tulong),
...
(Stmt.Ssequence
  ...
  (Stmt.Ssequence
    (Stmt.Scall (some _t'1)
      (Expr.Evar _uncompress2 (Ty.Tfunction
                                [(tptr tuchar), (tptr tulong), (tptr tuchar),
                                 (tptr tulong)] tint cc_default))
      [(Expr.Etempvar _dest (tptr tuchar)),
       (Expr.Etempvar _destLen (tptr tulong)),
       (Expr.Etempvar _source (tptr tuchar)),
       (Expr.Eaddrof (Expr.Evar _used tulong) (tptr tulong))])
...
[(___compcert_va_int32,
 ...
 (___builtin_debug,
   GlobDef.Gfun (FunDef.External (ExtFun.EF_external "__builtin_debug"
     ...
     { cc_vararg := (some 1), cc_unproto := false, cc_structret := false })),
 (_inflate,
   GlobDef.Gfun (FunDef.External (ExtFun.EF_external "inflate"
                                   (mksignature [XType.Xptr, XType.Xint]
                                     XType.Xint cc_default))
     [(tptr (Ty.Tstruct _z_stream_s noattr)), tint] tint cc_default)),
 (_inflateEnd,
   GlobDef.Gfun (FunDef.External (ExtFun.EF_external "inflateEnd"
                                   (mksignature [XType.Xptr] XType.Xint
                                     cc_default))
     [(tptr (Ty.Tstruct _z_stream_s noattr))] tint cc_default)),
 (_inflateInit_,
   GlobDef.Gfun (FunDef.External (ExtFun.EF_external "inflateInit_"
                                   (mksignature
                                     [XType.Xptr, XType.Xptr, XType.Xint]
                                     XType.Xint cc_default))
     [(tptr (Ty.Tstruct _z_stream_s noattr)), (tptr tschar), tint] tint
     cc_default)),
 (_uncompress2_z, GlobDef.Gfun (FunDef.Internal f_uncompress2_z)),
 (_uncompress2, GlobDef.Gfun (FunDef.Internal f_uncompress2)),
 (_uncompress_z, GlobDef.Gfun (FunDef.Internal f_uncompress_z)),
 (_uncompress, GlobDef.Gfun (FunDef.Internal f_uncompress))]

def public_idents : List Ident :=
[_uncompress, _uncompress_z, _uncompress2, _uncompress2_z, _inflateInit_,
 _inflateEnd, _inflate, ___builtin_debug, ___builtin_fmin, ___builtin_fmax,
